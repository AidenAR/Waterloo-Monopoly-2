...
bool AcademicBuildings::partMonopoly() {

}


int AcademicBuildings::improvementCost() override;

string AcademicBuildings::getFacultyName(const string& buildingName,
                                         const std::map<std::string,
                                         std::tuple<std::string, int, int, int, int, int, int, int, int>>& buildings) {
